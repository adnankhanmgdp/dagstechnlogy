const documentUpdateRequestTemplate = (username) => {
    return `<!DOCTYPE html>
    <html>
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        <div class="container">
            ...
            <div class="body">
                ...
                <p>To complete your registration, please update your documents to verify your account.</p>
            </div>
...
module.exports = documentUpdateRequestTemplate;
