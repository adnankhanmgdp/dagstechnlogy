...
const handleEditorChange = (content) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setPrivacyPolicy(data.refundPolicy.replace(/\|\|/g, "<br>"));
      toast.success("Return and Cancellation policy successfully updated");
    } catch (error) {
      toast.error("Failed to update Return and Cancellation policy");
    }
  };
  ...
  useEffect(() => {
    ...
    const fetchPrivacyPolicy = async () => {
      try {
        ...
        setPrivacyPolicy(data.charges.refundPolicy.replace(/\|\|/g, "<br>"));
      } catch (error) {
      ...
      <div className="page-content" style={styles.pageContent}>
        {showEditor ? (
          ...
          <div style={styles.policyContainer}>
            ...
            ></div>
            <button
              className="w-25 border-0 bg-primary text-white p-1"
