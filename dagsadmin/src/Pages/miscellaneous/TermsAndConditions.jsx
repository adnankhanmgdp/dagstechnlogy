...
const TermsAndConditions = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setPrivacyPolicy(data.tnc.replace(/\|\|/g, "<br>"));
      toast.success("Term and Conditions successfully updated");
    } catch (error) {
  ...
  useEffect(() => {
    ...
    const fetchPrivacyPolicy = async () => {
      try {
        ...
        const data = await res.json();
        setPrivacyPolicy(data.charges.tnc.replace(/\|\|/g, "<br>"));
      } catch (error) {
      ...
      <div className="page-content" style={styles.pageContent}>
        {showEditor ? (
          ...
          <div style={styles.policyContainer}>
            ...
            ></div>
            <button
              className="w-25 mt-5 border-0 bg-primary text-white p-1"
