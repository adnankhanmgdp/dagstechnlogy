...
const LogisticSettlement = () => {
  ...
  useEffect(() => {
    const logisticPickupSettlement = async () => {
      try {
        const res = await fetch(
          `${process.env.REACT_APP_API_URL}/pickupSettlement`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
  ...
  const closeSettleModal = () => {
    ...
    navigate("/settlement/LogisticSettlementPickup");
  };

  const paymentDone = async () => {
    try {
      const res = await fetch(
        `${process.env.REACT_APP_API_URL}/settlePickedAmount`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
...
export default LogisticSettlement;
